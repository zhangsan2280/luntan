...
public class CreateBean {
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.rootPath()+File.separator+"cms"+File.separator+"bean"+File.separator+"like"+File.separator+"CommentLike_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.rootPath()+File.separator+"cms"+File.separator+"bean"+File.separator+"like"+File.separator+"CommentReplyLike_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.rootPath()+File.separator+"cms"+File.separator+"bean"+File.separator+"like"+File.separator+"QuestionLike_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.rootPath()+File.separator+"cms"+File.separator+"bean"+File.separator+"like"+File.separator+"AnswerLike_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.rootPath()+File.separator+"cms"+File.separator+"bean"+File.separator+"like"+File.separator+"AnswerReplyLike_"+tableNumber+".class");
